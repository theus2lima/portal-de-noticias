-- ============================================
-- PORTAL DE NOTÍCIAS - SCHEMA SUPABASE
-- ============================================
...
CREATE TABLE IF NOT EXISTS users (
    ...
    role VARCHAR(20) DEFAULT 'editor' CHECK (role IN ('admin', 'editor', 'writer')),
    bio TEXT,
    avatar_url TEXT,
...
-- ============================================
-- Descommente se quiser usar RLS para segurança adicional

-- ALTER TABLE articles ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE categories ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE users ENABLE ROW LEVEL SECURITY;

-- CREATE POLICY "Articles são visíveis para todos" ON articles FOR SELECT USING (true);
-- CREATE POLICY "Apenas admins podem inserir articles" ON articles FOR INSERT WITH CHECK (auth.role() = 'admin');
