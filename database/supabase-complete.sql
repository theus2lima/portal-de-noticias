-- ============================================
-- PORTAL DE NOTÍCIAS - CONFIGURAÇÃO COMPLETA SUPABASE
-- ============================================
...
-- VERIFICAÇÃO FINAL
-- ============================================
-- Este SELECT mostrará quantos registros foram criados
SELECT 
...
UNION ALL
SELECT 
  'tags' as tabela, COUNT(*) as registros FROM tags
ORDER BY tabela;
